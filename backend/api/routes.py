...
# Schema matching the frontend JSON payload
...
async def route_traffic(flow: NetworkFlow):
    try:
        # Convert the Pydantic model to a dictionary and pass to the AI
        decision = inference_engine.predict_route(flow.dict())

...
export default function TopologyMap({ intelligence }: any) {
  ...
  useEffect(() => {
    ...
    const regions = [
      { id: "HOSP", label: "Hospital Zone", d: "M 100,100 L 300,80 L 350,220 L 150,280 Z", cx: 220, cy: 170 },
      { id: "FIRE", label: "Fire & Rescue", d: "M 300,80 L 550,110 L 480,250 L 350,220 Z", cx: 420, cy: 160 },
      { id: "HQ", label: "Command HQ", d: "M 350,220 L 480,250 L 450,400 L 320,380 Z", cx: 400, cy: 300 },
      { id: "POL", label: "Police Dept", d: "M 150,280 L 350,220 L 320,380 L 120,420 Z", cx: 230, cy: 320 },
      { id: "RES", label: "Residential", d: "M 480,250 L 700,200 L 750,380 L 550,450 L 450,400 Z", cx: 580, cy: 310 },
      { id: "ENT", label: "Entertainment", d: "M 550,450 L 750,380 L 800,480 L 500,520 Z", cx: 650, cy: 450 },
      { id: "MED", label: "Media Broadcast", d: "M 120,420 L 320,380 L 450,400 L 550,450 L 500,520 L 200,500 Z", cx: 330, cy: 450 },
    ];

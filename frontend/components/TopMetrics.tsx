export default function TopMetrics({ 
  ...
  // Calculate basic stats safely with optional chaining
  ...
  const MetricCard = ({ title, value, colorClass = "text-slate-100", pulse = false }: any) => (
     <div className="bg-[#0B1120]/80 backdrop-blur-md border border-slate-800/80 p-3 rounded-lg flex flex-col justify-center relative overflow-hidden">
  ...
  return (
    <div className="grid grid-cols-4 lg:grid-cols-8 gap-2">
      <MetricCard title="Active Flows" value={packets?.length || 0} />
